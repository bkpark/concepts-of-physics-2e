...
page='<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>1.1 backport review</title>'+style+'<h1>1.1 backport: opening chapters</h1><p class="notice">BR01 and BR02 are applied. Thirteen other opening-chapter corrections have been applied and are listed afterward. The full-book backport is not complete. Published 1.0 is unchanged.</p><p><a href="#BR01">BR01: kilogram wording</a> · <a href="#BR02">BR02: exercise diagram</a> · <a href="#applied">Applied corrections</a></p>'
