...
</style><h1>Special Relativity: review for 1.1</h1><p class="notice"><b>SR01 and SR02 applied to the maintained 1.1 source.</b> The live textbook, published PDF, and frozen 1.0 release are unchanged. The inventory compares the frozen 1.0 baseline against upstream. Comparison source: OpenStax College Physics 2e, CC BY 4.0, February 4, 2026.</p><nav><a href="#SR01">SR01 · Simultaneity</a> · <a href="#SR02">SR02 · Upstream stars-to-bodies wording</a> · <a href="#followup">Further review</a> · <a href="#inventory">Seven-section inventory</a></nav>'''
...
item=proposal['items'][1];page+='<section id="SR02"><h2>SR02 — Upstream stars-to-bodies wording</h2><p>In the Alpha Centauri example’s strategy paragraph, changed <q>'+esc(item['before'])+'</q> to <q>'+esc(item['after'])+'</q>. Applied the pinned CC BY upstream wording. The example title, values, equations and reasoning remain unchanged.</p><p><a href="'+'../../course-full/sections/'+sections[item['module']]['slug']+'/index.html#'+item['module']+'--'+item['source_id'].encode('utf-8').hex()+'">Read this sentence in context</a></p></section>'
