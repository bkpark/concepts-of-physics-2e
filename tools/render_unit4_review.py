...
page+='<p>Quantum mechanics, relativity, nuclear and particle physics — 29 sections, plus four supporting appendices.</p><p class="notice">'+str(len(batch['changes']))+' scoped correction records applied to the maintained development draft. All Unit 4 author review items below are resolved; other retained differences are listed separately. Existing section identities, numbering, organization and exercise placement are preserved. Published 1.0 is unchanged.</p>'
