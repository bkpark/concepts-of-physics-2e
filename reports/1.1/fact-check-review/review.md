...
Coordinate the risk discussion around an explicit, order-of-magnitude lifetime estimate. The main paragraph now calculates 0.03 percent for 1 rem and 3 percent for 100 rem directly from 300 in a million per rem, with the uncertainty stated for both results. Remove the fixed annual risk multiplied by 30 years and the unsupported worldwide 20 percent comparison. Replace the incorrect 1 Sv average-survivor-dose claim with RERF's reported average of about 0.2 Gy for survivors within 2,500 m of the hypocenters. Preserve Gy as the source's absorbed-dose unit; do not equate this directly with the preceding effective-dose estimate in Sv. Replace impossible-to-detect with difficult-to-detect and distinguish illustrative estimates from observed survivor evidence. Related drafts below address the earlier linear-hypothesis and lifetime-coefficient paragraphs. Their unchanged introductory claims and the later genetic-risk/hormesis claims still await coordinated review; FC29 is not complete.
...
**Proposed:** If a person receives a whole-body dose of 1 rem, this estimate gives an additional lifetime risk of dying from radiation-induced cancer of about 300 in a million, or 0.03 percent. For 100 rem (1 Sv), the same linear estimate gives an additional 3 percent risk. These are rough estimates, within an order of magnitude. Since cancer is already a common cause of death, the small increase estimated for a 1 rem exposure is difficult to detect statistically. Increased cancer risk has, however, been observed in studies of Hiroshima and Nagasaki survivors. The Radiation Effects Research Foundation reports an average dose of about 0.2 Gy for survivors within 2,500 m of the hypocenters; individual doses varied widely.
