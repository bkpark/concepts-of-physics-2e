# Focused fact-check for 1.1

Review snapshot 2026-09-19. Approved cycle applied to the maintained preview; additional leads remain open.

## FC01 — The meter does not change when light-speed measurements improve

Physical Quantities and Units · applied-author-directed
...
Half-Life and Activity · applied-author-directed
...
**Before this review cycle:** or 3.70×1010 decays per second. A curie is a large unit of activity, while a becquerel is a relatively small unit. 1 MBq=100 microcuries (μCi). In countries like Australia and New Zealand that adhere more to SI units, most radioactive sources, such as those used in medical diagnostics or in physics laboratories, are labeled in Bq or megabecquerel (MBq).

**Approved change — applied:** or 3.70×1010 decays per second. A curie is a large unit of activity, while a becquerel is a relatively small unit. 1 MBq≈27.0 microcuries (μCi). In countries like Australia and New Zealand that adhere more to SI units, most radioactive sources, such as those used in medical diagnostics or in physics laboratories, are labeled in Bq or megabecquerel (MBq).

- [NIST: unit conversion factors](https://www.nist.gov/pml/special-publication-811/nist-guide-si-appendix-b-conversion-factors/nist-guide-si-appendix-b9)

## FC04 — Heisenberg uncertainty principle: 1927

Uncertainty Principle · applied-author-directed

The uncertainty principle dates to 1927, not 1929.

**Before this review cycle:** It was Werner Heisenberg who first stated this limit to knowledge in 1929 as a result of his work on quantum mechanics and the wave characteristics of all particles. (See ). Specifically, consider simultaneously measuring the position and momentum of an electron (it could be any particle). There is an uncertainty in position Δx that is approximately equal to the wavelength of the particle. That is,

**Approved change — applied:** It was Werner Heisenberg who first stated this limit to knowledge in 1927 as a result of his work on quantum mechanics and the wave characteristics of all particles. (See ). Specifically, consider simultaneously measuring the position and momentum of an electron (it could be any particle). There is an uncertainty in position Δx that is approximately equal to the wavelength of the particle. That is,

- [Nobel: quantised world, uncertainty](https://educationalgames.nobelprize.org/educational/physics/quantised_world/final-3.html)

## FC05 — Date the electron-diffraction confirmation to 1927

The Wave Nature of Matter · applied-author-directed
...
**Before this review cycle:** American physicists Clinton J. Davisson and Lester H. Germer in 1925 and, independently, British physicist G. P. Thomson (son of J. J. Thomson, discoverer of the electron) in 1926 scattered electrons from crystals and found diffraction patterns. These patterns are exactly consistent with interference of electrons having the de Broglie wavelength and are somewhat analogous to light interacting with a diffraction grating. (See .)

**Approved change — applied:** American physicists Clinton J. Davisson and Lester H. Germer in 1927 and, independently, British physicist G. P. Thomson (son of J. J. Thomson, discoverer of the electron) in 1927 scattered electrons from crystals and found diffraction patterns. These patterns are exactly consistent with interference of electrons having the de Broglie wavelength and are somewhat analogous to light interacting with a diffraction grating. (See .)

- [Davisson: Nobel lecture (first paragraph)](https://www.nobelprize.org/uploads/2018/06/davisson-lecture.pdf)

## FC06 — Newton’s Mint post and the coin-edge claim

Physics: An Introduction · applied-author-directed
...
Nuclear Weapons · applied-author-directed

The 1951 award was Chemistry. Other problems in this paragraph are separately listed under the nuclear-history hold.

**Before this review cycle:** It was not until December 6, 1941, the day before the Japanese attack on Pearl Harbor, that the United States made a massive commitment to building a nuclear bomb. The top secret Manhattan Project was a crash program aimed at beating the Germans. It was carried out in remote locations, such as Los Alamos, New Mexico, whenever possible, and eventually came to cost billions of dollars and employ the efforts of more than 100,000 people. J. Robert Oppenheimer (1904–1967), whose talent and ambitions made him ideal, was chosen to head the project. The first major step was made by Enrico Fermi and his group in December 1942, when they achieved the first self-sustained nuclear reactor. This first “atomic pile”, built in a squash court at the University of Chicago, used carbon blocks to thermalize neutrons. It not only proved that the chain reaction was possible, it began the era of nuclear reactors. Glenn Seaborg, an American chemist and physicist, received the Nobel Prize in physics in 1951 for discovery of several transuranic elements, including plutonium. Carbon-moderated reactors are relatively inexpensive and simple in design and are still used for breeding plutonium, such as at Chernobyl, where two such reactors remain in operation.

**Approved change — applied:** It was not until December 6, 1941, the day before the Japanese attack on Pearl Harbor, that the United States made a massive commitment to building a nuclear bomb. The top secret Manhattan Project was a crash program aimed at beating the Germans. It was carried out in remote locations, such as Los Alamos, New Mexico, whenever possible, and eventually came to cost billions of dollars and employ the efforts of more than 100,000 people. J. Robert Oppenheimer (1904–1967), whose talent and ambitions made him ideal, was chosen to head the project. The first major step was made by Enrico Fermi and his group in December 1942, when they achieved the first self-sustained nuclear reactor. This first “atomic pile”, built in a squash court at the University of Chicago, used carbon blocks to thermalize neutrons. It not only proved that the chain reaction was possible, it began the era of nuclear reactors. Glenn Seaborg, an American chemist and physicist, received the Nobel Prize in chemistry in 1951 for discovery of several transuranic elements, including plutonium. Carbon-moderated reactors are relatively inexpensive and simple in design and are still used for breeding plutonium, such as at Chernobyl, where two such reactors remain in operation.

- [Nobel Prize in Chemistry 1951](https://www.nobelprize.org/prizes/chemistry/1951/summary/_/)

## FC08 — Gell-Mann: lifespan and quark proposal date

Particles, Patterns, and Conservation Laws · applied-author-directed

Use 1929–2019 and 1964. This does not attempt a broader history of the independently proposed quark model.

**Before this review cycle:** Murray Gell-Mann (b. 1929) proposed quarks as a substructure of hadrons in 1963 and was already known for his work on the concept of strangeness. Although quarks have never been directly observed, several predictions of the quark model were quickly confirmed, and their properties explain all known hadron characteristics. Gell-Mann was awarded the Nobel Prize in 1969. (credit: Luboš Motl)

**Approved change — applied:** Murray Gell-Mann (1929–2019) proposed quarks as a substructure of hadrons in 1964 and was already known for his work on the concept of strangeness. Although quarks have never been directly observed, several predictions of the quark model were quickly confirmed, and their properties explain all known hadron characteristics. Gell-Mann was awarded the Nobel Prize in 1969. (credit: Luboš Motl)

- [Nobel: 1990 illustrated presentation, timeline](https://www.nobelprize.org/prizes/physics/1990/9592-the-nobel-prize-in-physics-1990/)
- [CERN Courier: Gell-Mann tribute](https://repository.cern/records/1mfzw-nn179/files/CCJulAug19-digital.pdf?download=1)
...
**Before this review cycle:** Modern civilization depends on energy, but current levels of energy consumption and production are not sustainable. The likelihood of a link between global warming and fossil fuel use (with its concomitant production of carbon dioxide), has made reduction in energy use as well as a shift to non-fossil fuels of the utmost importance. Even though energy in an isolated system is a conserved quantity, the final result of most energy transformations is waste heat transfer to the environment, which is no longer useful for doing work. As we will discuss in more detail later, the potential for energy to produce useful work has been “degraded” in the energy transformation.

**Approved change — applied:** Modern civilization depends on energy, but current levels of energy consumption and production are not sustainable. The link between global warming and fossil fuel use (with its concomitant production of carbon dioxide), has made reduction in energy use as well as a shift to non-fossil fuels of the utmost importance. Even though energy in an isolated system is a conserved quantity, the final result of most energy transformations is waste heat transfer to the environment, which is no longer useful for doing work. As we will discuss in more detail later, the potential for energy to produce useful work has been “degraded” in the energy transformation.
...
Medical Imaging and Diagnostics · applied-author-directed
...
**Before this review cycle:**  lists certain medical diagnostic uses of radiopharmaceuticals, including isotopes and activities that are typically administered. Many organs can be imaged with a variety of nuclear isotopes replacing a stable element by a radioactive isotope. One common diagnostic employs iodine to image the thyroid, since iodine is concentrated in that organ. The most active thyroid cells, including cancerous cells, concentrate the most iodine and, therefore, emit the most radiation. Conversely, hypothyroidism is indicated by lack of iodine uptake. Note that there is more than one isotope that can be used for several types of scans. Another common nuclear diagnostic is the thallium scan for the cardiovascular system, particularly used to evaluate blockages in the coronary arteries and examine heart activity. The salt TlCl can be used, because it acts like NaCl and follows the blood. Gallium-67 accumulates where there is rapid cell growth, such as in tumors and sites of infection. Hence, it is useful in cancer imaging. Usually, the patient receives the injection one day and has a whole body scan 3 or 4 days later because it can take several days for the gallium to build up.

**Approved change — applied:**  lists certain medical diagnostic uses of radiopharmaceuticals, including isotopes and activities that are typically administered. Many organs can be imaged with a variety of nuclear isotopes replacing a stable element by a radioactive isotope. One common diagnostic employs iodine to image the thyroid, since iodine is concentrated in that organ. The most active thyroid cells, including cancerous cells, concentrate the most iodine and, therefore, emit the most radiation. Conversely, hypothyroidism is indicated by lack of iodine uptake. Note that there is more than one isotope that can be used for several types of scans. Another common nuclear diagnostic is the thallium scan for the cardiovascular system, particularly used to evaluate blockages in the coronary arteries and examine heart activity. The salt TlCl can be used, because thallium is taken up by viable heart muscle cells in a manner similar to potassium. Gallium-67 accumulates where there is rapid cell growth, such as in tumors and sites of infection. Hence, it is useful in cancer imaging. Usually, the patient receives the injection one day and has a whole body scan 3 or 4 days later because it can take several days for the gallium to build up.

- [DailyMed: thallous chloride Tl-201, mechanism](https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=0da81fc0-a137-46d3-9378-d8053a82e61a)
...
**Before this review cycle:** Note that lists many diagnostic uses for 99mTc, where “m” stands for a metastable state of the technetium nucleus. Perhaps 80 percent of all radiopharmaceutical procedures employ 99mTc because of its many advantages. One is that the decay of its metastable state produces a single, easily identified 0.142-MeV γ ray. Additionally, the radiation dose to the patient is limited by the short 6.0-h half-life of 99mTc. And, although its half-life is short, it is easily and continuously produced on site. The basic process for production is neutron activation of molybdenum, which quickly β decays into 99mTc. Technetium-99m can be attached to many compounds to allow the imaging of the skeleton, heart, lungs, kidneys, etc.

**Approved change — applied:** Note that lists many diagnostic uses for 99mTc, where “m” stands for a metastable state of the technetium nucleus. Perhaps 80 percent of all radiopharmaceutical procedures employ 99mTc because of its many advantages. One is that the decay of its metastable state produces a single, easily identified 0.141-MeV γ ray. Additionally, the radiation dose to the patient is limited by the short 6.0-h half-life of 99mTc. And, although its half-life is short, it is easily and continuously produced on site. The basic process for production is neutron activation of molybdenum, which quickly β decays into 99mTc. Technetium-99m can be attached to many compounds to allow the imaging of the skeleton, heart, lungs, kidneys, etc.

- [DailyMed: technetium Tc-99m pentetate, physical characteristics](https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=59b3b7d5-ff69-4642-971e-99026d9dce89)

## FC18 — Elementary charge is fixed in the SI

Discovery of the Atomic Nucleus · applied-author-directed
...
**Before this review cycle:** Today, numerical values of electron and proton charge (whose magnitude is also known as "elementary charge" and denoted with symbol e) and electron and proton masses are measured and known to very high precision. Their values (only up to three significant figures) are,

**Approved change — applied:** Today, numerical values of electron and proton charge (whose magnitude is also known as "elementary charge" and denoted with symbol e) and electron and proton masses are known to very high precision. Before the SI redefinition that took effect in May 2019, the elementary charge was also measured. Its numerical value in coulombs is now fixed exactly to define the ampere, while electron and proton masses remain measured quantities. Their values (only up to three significant figures) are,
...
Motion Equations for Constant Acceleration in One Dimension · applied-author-directed

The vehicle’s proper name retains the u.

**Before this review cycle:** The Space Shuttle Endeavor blasts off from the Kennedy Space Center in February 2010. (credit: Matthew Simantov, Flickr)

**Approved change — applied:** The Space Shuttle Endeavour blasts off from the Kennedy Space Center in February 2010. (credit: Matthew Simantov, Flickr)

- [NASA: STS-130](https://www.nasa.gov/mission/sts-130/)

## FC20 — Retain film as a detector without a current market-share claim

Radiation Detection and Detectors · applied-author-directed
...
**Before this review cycle:** The first direct detection of radiation was Becquerel’s fogged photographic plate. Photographic film is still the most common detector of ionizing radiation, being used routinely in medical and dental x rays. Nuclear radiation is also captured on film, such as seen in . The mechanism for film exposure by ionizing radiation is similar to that by photons. A quantum of energy interacts with the emulsion and alters it chemically, thus exposing the film. The quantum come from an α-particle, β-particle, or photon, provided it has more than the few eV of energy needed to induce the chemical change (as does all ionizing radiation). The process is not 100% efficient, since not all incident radiation interacts and not all interactions produce the chemical change. The amount of film darkening is related to exposure, but the darkening also depends on the type of radiation, so that absorbers and other devices must be used to obtain energy, charge, and particle-identification information.

**Approved change — applied:** The first direct detection of radiation was Becquerel’s fogged photographic plate. Photographic film is one type of detector of ionizing radiation and has been widely used in medical and dental x rays. Nuclear radiation is also captured on film, such as seen in . The mechanism for film exposure by ionizing radiation is similar to that by photons. A quantum of energy interacts with the emulsion and alters it chemically, thus exposing the film. The quantum come from an α-particle, β-particle, or photon, provided it has more than the few eV of energy needed to induce the chemical change (as does all ionizing radiation). The process is not 100% efficient, since not all incident radiation interacts and not all interactions produce the chemical change. The amount of film darkening is related to exposure, but the darkening also depends on the type of radiation, so that absorbers and other devices must be used to obtain energy, charge, and particle-identification information.

- [ADA: radiography safety and digital imaging](https://www.ada.org/about/press-releases/ada-releases-updated-recommendations-to-enhance-radiography-safety-in-dentistry)
...
**Before this review cycle:** The Chernobyl reactor. More than 100 people died soon after its meltdown, and there will be thousands of deaths from radiation-induced cancer in the future. While the accident was due to a series of human errors, the cleanup efforts were heroic. Most of the immediate fatalities were firefighters and reactor personnel. (credit: Elena Filatova)

**Approved change — applied:** The Chernobyl reactor. About 30 workers died within weeks of the accident. Radiation exposure also increased thyroid-cancer incidence among people exposed as children or adolescents. While the accident was due to a series of human errors, the cleanup efforts were heroic. Most of the immediate fatalities were firefighters and reactor personnel. (credit: Elena Filatova)

- [UNSCEAR: Chernobyl assessment](https://www.unscear.org/unscear/en/areas-of-work/chernobyl.html)
...
**Before this review cycle:** The world was in turmoil when fission was discovered in 1938. The discovery of fission, made by two German physicists, Otto Hahn and Fritz Strassman, was quickly verified by two Jewish refugees from Nazi Germany, Lise Meitner and her nephew Otto Frisch. Fermi, among others, soon found that not only did neutrons induce fission; more neutrons were produced during fission. The possibility of a self-sustained chain reaction was immediately recognized by leading scientists the world over. The enormous energy known to be in nuclei, but considered inaccessible, now seemed to be available on a large scale.

**Approved change — applied:** The world was in turmoil when fission was discovered in 1938. The experimental results of two German chemists, Otto Hahn and Fritz Strassmann, were quickly interpreted as nuclear fission by two Jewish refugees from Nazi Germany, Lise Meitner and her nephew Otto Frisch. Fermi, among others, soon found that not only did neutrons induce fission; more neutrons were produced during fission. The possibility of a self-sustained chain reaction was immediately recognized by leading scientists the world over. The enormous energy known to be in nuclei, but considered inaccessible, now seemed to be available on a large scale.

- [Max Planck research history: Meitner–Frisch interpretation](https://www.mprl-series.mpg.de/proceedings/5/11/index.html)

## FC24 — Neutrino discovery: distinguish early evidence from confirmation

Nuclear Decay and Conservation Laws · applied-author-directed
...
**Before this review cycle:** The latest accomplishment on this concept is represented by the IKAROS (Interplanetary Kite-craft Accelerated by Radiation Of the Sun) project by Japan Aerospace Exploration Agency (JAXA), which was launched in May 2010. IKAROS solar sail is currently traveling through the solar system. During its six-month journey to Venus, acceleration and attitude control using the solar sail, rather than thrusters, were successfully tested. Last update from the spacecraft was in May 2014, on a ten-month orbit around the Sun. A scale model of the spacecraft is shown in .

**Approved change — applied:** One demonstration of this concept is the IKAROS (Interplanetary Kite-craft Accelerated by Radiation Of the Sun) project by Japan Aerospace Exploration Agency (JAXA), which was launched in May 2010. During its six-month journey to Venus, acceleration and attitude control using the solar sail, rather than thrusters, were successfully tested. JAXA reported receiving data from the spacecraft in April and May 2015. A scale model of the spacecraft is shown in . In 2019, The Planetary Society’s LightSail 2 demonstrated controlled changes to its orbit around Earth using the pressure of sunlight.
...
GUTs: The Unification of Forces · applied-author-directed
...
Fusion · applied-author-directed
...
**Before this review cycle:** The three keys to practical fusion energy generation are to achieve the temperatures necessary to make the reactions likely, to raise the density of the fuel, and to confine it long enough to produce large amounts of energy. These three factors—temperature, density, and time—complement one another, and so a deficiency in one can be compensated for by the others. Ignition is defined to occur when the reactions produce enough energy to be self-sustaining after external energy input is cut off. This goal, which must be reached before commercial plants can be a reality, has not been achieved. Another milestone, called break-even, occurs when the fusion power produced equals the heating power input. Break-even has nearly been reached and gives hope that ignition and commercial plants may become a reality in a few decades.

**Approved change — applied:** The three keys to practical fusion energy generation are to achieve the temperatures necessary to make the reactions likely, to raise the density of the fuel, and to confine it long enough to produce large amounts of energy. These three factors—temperature, density, and time—complement one another, and so a deficiency in one can be compensated for by the others. Ignition occurs when heating by the fusion reactions themselves is sufficient to sustain the burn while the fuel remains confined. Another milestone, called break-even, occurs when the fusion power produced equals the heating power input.

**Approved order change — applied:** Present inertial confinement before magnetic confinement. Move each existing figure with its explanatory paragraph; preserve all source IDs, figure assets, credits, and cross-reference targets. Displayed figure numbers will follow the new order when applied and rebuilt. The unchanged NIF figure and caption travel with its paragraph although only edited passages are shown below.

### Inertial confinement and NIF

**Before this review cycle:** The second promising technique aims multiple lasers at tiny fuel pellets filled with a mixture of deuterium and tritium. Huge power input heats the fuel, evaporating the confining pellet and crushing the fuel to high density with the expanding hot plasma produced. This technique is called inertial confinement, because the fuel’s inertia prevents it from escaping before significant fusion can take place. Higher densities have been reached than with tokamaks, but with smaller confinement times. In 2009, the Lawrence Livermore Laboratory (CA) completed a laser fusion device with 192 ultraviolet laser beams that are focused upon a D-T pellet (see ).

**Approved change — applied:** Two techniques are being studied for controlled fusion. One aims multiple lasers at tiny fuel pellets filled with a mixture of deuterium and tritium. Huge power input heats the fuel, evaporating the confining pellet and crushing the fuel to high density with the expanding hot plasma produced. This technique is called inertial confinement, because the fuel’s inertia prevents it from escaping before significant fusion can take place. Higher densities have been reached than with magnetic confinement, but with shorter confinement times. In 2009, Lawrence Livermore National Laboratory (CA) completed the National Ignition Facility (NIF), a laser fusion device with 192 ultraviolet laser beams that are focused upon a D-T pellet (see ). In December 2022, NIF achieved ignition and exceeded break-even relative to the laser energy delivered to its target, producing 3.15 MJ of fusion energy from 2.05 MJ of laser energy. For these pulsed experiments, the comparison is between energies rather than steady power levels. In April 2025, another experiment produced 8.6 MJ from 2.08 MJ of laser energy. These experiments did not produce net usable energy: operating the lasers required much more energy than was released by fusion. Practical fusion power plants remain a goal requiring substantial further development.

### Magnetic confinement and ITER

**Before this review cycle:** Two techniques have shown considerable promise. The first of these is called magnetic confinement and uses the property that charged particles have difficulty crossing magnetic field lines. The tokamak, shown in , has shown particular promise. The tokamak’s toroidal coil confines charged particles into a circular path with a helical twist due to the circulating ions themselves. In 1995, the Tokamak Fusion Test Reactor at Princeton in the US achieved world-record plasma temperatures as high as 500 million degrees Celsius. This facility operated between 1982 and 1997. A joint international effort is underway in France to build a tokamak-type reactor that will be the stepping stone to commercial power. ITER, as it is called, will be a full-scale device that aims to demonstrate the feasibility of fusion energy. It will generate 500 MW of power for extended periods of time and will achieve break-even conditions. It will study plasmas in conditions similar to those expected in a fusion power plant. Completion is scheduled for 2018.

**Approved change — applied:** The other technique is called magnetic confinement and uses the property that charged particles have difficulty crossing magnetic field lines. One device used for magnetic confinement is the tokamak, shown in . The tokamak’s toroidal coil confines charged particles into a circular path with a helical twist due to the circulating ions themselves. In 1995, the Tokamak Fusion Test Reactor at Princeton in the US achieved world-record plasma temperatures as high as 500 million degrees Celsius. This facility operated between 1982 and 1997. A joint international effort is underway in France to build a tokamak-type reactor as a stepping stone toward commercial power. ITER, as it is called, will be a full-scale device that aims to demonstrate the feasibility of fusion energy. It is designed to produce 500 MW of fusion power from 50 MW of heating power supplied to the plasma. This comparison does not include the power needed to operate the whole facility, and ITER will not generate electricity. It will study plasmas in conditions similar to those expected in a fusion power plant.

### ITER figure caption

**Before this review cycle:** (a) Artist’s rendition of ITER, a tokamak-type fusion reactor being built in southern France. It is hoped that this gigantic machine will reach the break-even point. Completion is scheduled for 2018. (credit: Stephan Mosel, Flickr)

**Approved change — applied:** (a) Artist’s rendition of ITER, a tokamak-type fusion reactor being built in southern France. It is designed to produce more fusion power than the heating power supplied to its plasma, but will not generate electricity. (credit: Stephan Mosel, Flickr)
...
- [ITER: machine assembly and proposed research-operation schedule](https://www.iter.org/project/assembly-overview)

## FC28 — Radiation dose limits: replace the mixed regulatory claims

Biological Effects of Ionizing Radiation · applied-author-directed
...
Keep the detectability explanation next to the 1 rem calculation. Replace the old 100 rem average-survivor claim with the reported average of about 0.2 Gy for survivors within 2,500 m, presented as roughly comparable to 20 rem of whole-body gamma exposure for this illustrative calculation. The existing lifetime coefficient gives 0.6 percent additional absolute risk at 20 rem. This gamma-equivalent, whole-body comparison is an approximation, not an exact conversion of organ absorbed dose to effective dose: RERF analyses account for differing gamma and neutron effectiveness. Clearly label both risk estimates as order-of-magnitude calculations, not measured survivor risks. Name RERF's Life Span Study and link its mortality report. Avoid attaching the separate illustrative 20 percent lifetime baseline to the specific mortality-study cohort; retain the 20 percent figure as a separate RERF lifetime comparison. The main paragraph and the two related substitutions below are approved. Unresolved adjacent claims are separately recorded in the follow-up register and are not cleared by this approval.

**Before this review cycle:** If a person receives a dose of 1 rem, his risk each year of dying from radiation-induced cancer is 10 in a million and that risk continues for about 30 years. The lifetime risk is thus 300 in a million, or 0.03 percent. Since about 20 percent of all worldwide deaths are from cancer, the increase due to a 1 rem exposure is impossible to detect demographically. But 100 rem (1 Sv), which was the dose received by the average Hiroshima and Nagasaki survivor, causes an additional 3 percent risk, which can be observed with statistical significance above the 20 percent natural incidence rate.

**Approved change — applied:** If a person receives a whole-body dose of 1 rem, this estimate gives an additional lifetime risk of dying from radiation-induced cancer of about 300 in a million, or 0.03 percent. Since cancer is already a common cause of death, such a small increase is difficult to detect statistically. For Hiroshima and Nagasaki survivors within 2,500 m of the hypocenters, the reported average dose was about 0.2 Gy, roughly comparable to 20 rem of whole-body gamma exposure. Our linear estimate would give an additional lifetime risk of about 0.6 percent for that exposure. Both risk estimates are approximate, within an order of magnitude. The Radiation Effects Research Foundation’s Life Span Study has detected increased cancer mortality among Hiroshima and Nagasaki survivors. For comparison, RERF gives a background lifetime cancer mortality risk of roughly 20 percent for unexposed people.

### Earlier paragraph: linear hypothesis and cellular repair

**Before this review cycle:** The two known long-term effects of radiation are cancer and genetic defects. Both are directly attributable to the interference of radiation with cell reproduction. For high doses of radiation, the risk of cancer is reasonably well known from studies of exposed groups. Hiroshima and Nagasaki survivors and a smaller number of people exposed by their occupation, such as radium dial painters, have been fully documented. Chernobyl victims will be studied for many decades, with some data already available. For example, a significant increase in childhood thyroid cancer has been observed. The risk of a radiation-induced cancer for low and moderate doses is generally assumed to be proportional to the risk known for high doses. Under this assumption, any dose of radiation, no matter how small, involves a risk to human health. This is called the linear hypothesis and it may be prudent, but it is controversial. There is some evidence that, unlike the immediate effects of radiation, the long-term effects are cumulative and there is little self-repair. This is analogous to the risk of skin cancer from UV exposure, which is known to be cumulative.

**Approved change — applied:** The two known long-term effects of radiation are cancer and genetic defects. Both are directly attributable to the interference of radiation with cell reproduction. For high doses of radiation, the risk of cancer is reasonably well known from studies of exposed groups. Hiroshima and Nagasaki survivors and a smaller number of people exposed by their occupation, such as radium dial painters, have been fully documented. Chernobyl victims will be studied for many decades, with some data already available. For example, a significant increase in childhood thyroid cancer has been observed. The risk of a radiation-induced cancer for low and moderate doses is generally assumed to be proportional to the risk known for high doses. Under this assumption, any dose of radiation, no matter how small, involves a risk to human health. This is called the linear hypothesis, or linear no-threshold model, and is used in radiation protection. The size of the cancer risk at very low doses remains uncertain. Cells can repair radiation damage, but some damage may remain or be repaired incorrectly.

### Lifetime-risk estimate with explicit numbers

**Before this review cycle:** There is a latency period for the onset of radiation-induced cancer of about 2 years for leukemia and 15 years for most other forms. The person is at risk for at least 30 years after the latency period. Omitting many details, the overall risk of a radiation-induced cancer death per year per rem of exposure is about 10 in a million, which can be written as 10/106rem·yr.

**Approved change — applied:** There is a latency period for the onset of radiation-induced cancer of about 2 years for leukemia and 15 years for most other forms. The person is at risk for at least 30 years after the latency period. Omitting many details, the additional lifetime risk of dying from radiation-induced cancer is about 300 in 106 per rem of whole-body exposure, within an order of magnitude.
...
- [RERF: dose estimation and gamma/neutron weighting](https://www.rerf.or.jp/en/programs/general_research_e/raditiondose_e/)
- [RERF: radiation and health, baseline lifetime cancer mortality comparison](https://www.rerf.or.jp/uploads/2017/09/basicg_e.pdf)
- [RERF: sievert and radiation quality factors](https://www.rerf.or.jp/en/glossary/sievert-en/)
...
Forced Oscillations and Resonance · applied-author-directed
...
**Before this review cycle:** These features of driven harmonic oscillators apply to a huge variety of systems. When you tune a radio, for example, you are adjusting its resonant frequency so that it only oscillates to the desired station’s broadcast (driving) frequency. The more selective the radio is in discriminating between stations, the smaller its damping. Magnetic resonance imaging (MRI) is a widely used medical diagnostic tool in which atomic nuclei (mostly hydrogen nuclei) are made to resonate by incoming radio waves (on the order of 100 MHz). A child on a swing is driven by a parent at the swing’s natural frequency to achieve maximum amplitude. In all of these cases, the efficiency of energy transfer from the driving force into the oscillator is best at resonance. Speed bumps and gravel roads prove that even a car’s suspension system is not immune to resonance. In spite of finely engineered shock absorbers, which ordinarily convert mechanical energy to thermal energy almost as fast as it comes in, speed bumps still cause a large-amplitude oscillation. On gravel roads that are corrugated, you may have noticed that if you travel at the “wrong” speed, the bumps are very noticeable whereas at other speeds you may hardly feel the bumps at all. shows a photograph of a famous example (the Tacoma Narrows Bridge) of the destructive effects of a driven harmonic oscillation. The Millennium Bridge in London was closed for a short period of time for the same reason while inspections were carried out.

**Approved change — applied:** These features of driven harmonic oscillators apply to a huge variety of systems. When you tune a radio, for example, you are adjusting its resonant frequency so that it only oscillates to the desired station’s broadcast (driving) frequency. The more selective the radio is in discriminating between stations, the smaller its damping. Magnetic resonance imaging (MRI) is a widely used medical diagnostic tool in which atomic nuclei (mostly hydrogen nuclei) are made to resonate by incoming radio waves (on the order of 100 MHz). A child on a swing is driven by a parent at the swing’s natural frequency to achieve maximum amplitude. In all of these cases, the efficiency of energy transfer from the driving force into the oscillator is best at resonance. Speed bumps and gravel roads prove that even a car’s suspension system is not immune to resonance. In spite of finely engineered shock absorbers, which ordinarily convert mechanical energy to thermal energy almost as fast as it comes in, speed bumps still cause a large-amplitude oscillation. On gravel roads that are corrugated, you may have noticed that if you travel at the “wrong” speed, the bumps are very noticeable whereas at other speeds you may hardly feel the bumps at all. Damping is also important in controlling bridge oscillations. shows the Tacoma Narrows Bridge, which collapsed in 1940 after wind caused growing oscillations. The Millennium Bridge in London was closed after pedestrians caused excessive swaying and reopened after additional damping was installed to reduce the motion.

### Tacoma Narrows figure caption

**Before this review cycle:** In 1940, the Tacoma Narrows Bridge in Washington state collapsed. Heavy cross winds drove the bridge into oscillations at its resonant frequency. Damping decreased when support cables broke loose and started to slip over the towers, allowing increasingly greater amplitudes until the structure failed (credit: PRI's Studio 360, via Flickr)

**Approved change — applied:** In 1940, the Tacoma Narrows Bridge in Washington state collapsed. Cross winds drove the bridge into twisting oscillations. Damping was insufficient to control the motion, allowing increasingly greater amplitudes until the structure failed (credit: PRI's Studio 360, via Flickr)
...
## FC34 — Technetium supply: generator versus on-site neutron activation

Medical Imaging and Diagnostics · applied-author-directed

The text blurs production of the parent isotope and extraction of Tc-99m at the clinic. The generator label confirms Mo-99 decay (66-hour half-life) and recovery of its Tc-99m daughter. Suggested replacement for the two production sentences: “On site, technetium-99m is commonly obtained from a generator containing molybdenum-99, which decays to technetium-99m.” Retain the imaging applications and six-hour half-life. The separate diagnostic-isotope/activity table still needs clinical-context review; this is not a recommendation of administered activities.
...
- All 35 approved items were applied to the maintained 1.1 preview on 2026-09-20. Comparisons preserve the reviewed snapshots and may show only the scoped edit; the textbook context links show the combined result.
...
## Additional leads, not independently resolved

- **Additional historical details:** Doppler/Buys Ballot train-experiment attribution, Michelson experiment date/distance, de Broglie proposal versus dissertation date, Shroud of Turin location/date, Clausius spelling, and the dated Three Gorges completion claim remain screening leads. Do not classify these as verified corrections yet.
- **Radiation and medical tables:** Diagnostic-dose table already updated in U4-22. The separate administered-isotope/activity table, background-dose table, fixed cancer-latency/risk coefficients, and CT procedure-share statistics are not independently certified by this pass. Resolve material medical issues before describing 1.1 as fact-checked.
- **Radiation explanations:** FC29's three explicit paragraph edits were approved on 2026-09-20. Remaining connected claims are NOT resolved: the earlier paragraph's broad genetic-effects introduction; fixed latency generalizations; the following paragraph's one-third hereditary-risk ratio and numerical coefficient, categorical dismissal of animal evidence, claim that LNT likely overestimates risk, and hormesis discussion; and matching outdated annual-risk/genetic-risk statements in the section summary. Review these before closing the radiation-risk audit, and reconcile the summary with approved FC28b/FC29 changes during application. Also review RBE/quality-factor/effective-dose distinctions, beta shielding (bremsstrahlung in lead), claims about radiation range being directly proportional to energy, and the blanket superiority of cancer-cell radiosensitivity before a broader medical rewrite. Include adjacent electrical-safety claims about the heart being unaffected by current through the brain and high-frequency current traveling only on the body surface (m52406, import-auto-id1926340); verify these rather than treating them as established safety assurances.
- **Other current-technology claims:** AM/ELF frequency ranges, mobile-phone frequency generalizations, a 90-km accelerator example, present-tense nuclear-power counts, and superlatives such as the most famous infrared telescope need dating or qualification if retained. These are not automatically factual errors solely because the prose is old.
- **Conceptual qualifications:** The banked-curve normal-force sentence, force/action-reaction wording in spring work, specific gravity and floating in fluids other than water, pressure-work conventions, entropy formula assumptions, and simultaneity/light-travel-time shorthand merit targeted author read-through. Preserve the already agreed conservative-force heuristic; do not reopen it without new evidence.
- **Already resolved or deliberately deferred:** Preserve the accepted kilogram/ampere and mu0 updates, photoelectric rounding, tau-decay repair, 2020 ozone wording, power-line health qualification, diagnostic-dose table and approved history additions. Plasma expansion and ordinary exercise revision remain separately deferred. None of these is undone by the new audit.
