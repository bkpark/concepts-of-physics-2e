...
## FC31 — Keep the bridges as examples of damaging oscillations

Forced Oscillations and Resonance · proposed-not-applied

Propose retaining both bridge references and the existing Tacoma photograph, without teaching wind dynamics or torsional flutter. Introduce them as examples of large, damaging oscillations and explicitly distinguish them from the simple forced-resonance examples above. The Millennium Bridge sentence connects its remedial work to damping, which the section already teaches. Shorten the Tacoma caption to the supported event and motion, retaining the credit and figure identity. This is an alternative for author review, not an applied edit.
...
**Proposed:** In 1940, the Tacoma Narrows Bridge in Washington state collapsed after wind caused growing twisting oscillations. (credit: PRI's Studio 360, via Flickr)
