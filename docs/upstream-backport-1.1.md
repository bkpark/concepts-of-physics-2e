...
- Pending author choices are BR01 (three past-tense kilogram substitutions retaining the author's exact Planck-constant addition) and BR02 (a position-axis label repair without adopting the upstream's inconsistent path-C endpoint). See `proposals/1.1/opening-review.json`.
